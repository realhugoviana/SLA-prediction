...
runlog_data = pd.read_csv("stats_entrainement/MLP_ALSFRS-R_COMBINED/runlog_summary.csv")
runlog_data["dataset"] = runlog_data["dataset"].str.replace("MLP_alsfrs-r_combined_", "")
...
best_trials.to_csv("stats_entrainement/MLP_ALSFRS-R_COMBINED/best_trials_mae.csv", index=False)
