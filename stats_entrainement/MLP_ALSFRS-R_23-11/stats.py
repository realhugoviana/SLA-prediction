...
runlog_data = pd.read_csv("stats_entrainement/MLP_ALSFRS-R_23-11/runlog_summary.csv")
...
best_trials = best_trials[["dataset", "trial", "mae", "rmse", "r2", "n_layer", "n_units", "learning_rate", "decroissant"]]

best_trials.to_csv("stats_entrainement/MLP_ALSFRS-R_23-11/best_trials.csv", index=False)
