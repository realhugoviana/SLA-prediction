...
runlog_data = pd.read_csv("stats_entrainement/MLP_ALSFRS-R_LAB_NO_DELTA/runlog_summary.csv")
...
best_trials.to_csv("stats_entrainement/MLP_ALSFRS-R_LAB_NO_DELTA/best_trials_mae.csv", index=False)
